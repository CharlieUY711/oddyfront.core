...
// 1. Reemplazar boton market (6 lineas desde index 2847)
...
// 2. Agregar barra con carrusel y boton despues del </header>
...
lines.splice(headerCloseIdx + 1, 0,
  "      {/* Barra de modo */}",
  "      <div style={{ position: 'fixed', top: headerHeight, left: 0, right: 0, width: '100%', height: '48px', backgroundColor: isSH ? '#FF6835' : '#6BB87A', transition: 'background-color 0.4s ease', zIndex: 299, display: 'flex', alignItems: 'center', paddingRight: '12px' }}>",
  "        <button onClick={() => setMode(isSH ? 'mkt' : 'sh')} className=\"oddy-login-btn oddy-mode-btn\" style={{ flexShrink: 0, marginLeft: '12px', marginRight: '12px' }}>",
